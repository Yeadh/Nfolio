 ...
 *
 */
if( ! class_exists( 'CSF_Field_color_picker' ) ) {
  class CSF_Field_color_picker extends CSF_Fields {
    ...
    public function output() {
      ...
      echo '<input type="text" name="'. $this->element_name() .'" value="'. $this->element_value() .'"'. $this->element_class('csf-wp-color-picker') . $this->element_attributes( $this->extra_attributes() ) .'/>';
